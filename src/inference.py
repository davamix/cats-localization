...
from detentron2 import model_zoo
...
cfg = get_cfg()
cfg.merge_from_file(model_zoo.get_cofig_file("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"))
...
dataset_dicts = get_data_dicts("data/val")
